...
## 1．SDK适用语言<br/>
SDK适用于在C#(或其他.NET框架下语言)中调用service.youziku.com中的所有api<br/>

## 2.工作流程<br/>
　　①用户的后台程序调用SDK，提交动态内容到有字库的裁切服务器<br/>
　　②有字库将根据内容裁剪出对应的小字体文件，并转换为4种通用字体格式（woff、eot、ttf、svg）<br/>
　　③将字体文件上传至阿里云CDN<br/>
　　④用文件CDN地址生成@font-face语句<br/>
　　⑤将@font-face语句返回给程序<br/>
