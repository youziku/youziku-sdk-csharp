...
namespace Youziku.Validate
{
    public static class ParamValidate
    {
        ...
        public static void GetFontface(FontFaceParam param)
        {
            ...
            if (string.IsNullOrEmpty(param.AccessKey)) throw new ArgumentException(nameof(FontFaceParam) + " field AccessKey is null or Empty!");
            if (string.IsNullOrEmpty(param.Content)) throw new ArgumentException(nameof(FontFaceParam) + " field Content is null or Empty!");
        }
        #endregion
